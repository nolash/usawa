...
""",
    ...
    argp.add_argument(
        ...
        type=str,
        default=[],
        help="Add public key to list of valid signers",
    )
    argp.add_argument("-c", type=str, help="override config dir")
    argp.add_argument(
        "-u", type=str, default="./usawa.socket", help="UNIX Socket file to listen on"
    )
    argp.add_argument(
    ...
    elif cfg.get("STORE_TYPE") == "fs":
        base = cfg.get("FSSTORE_BASE")
